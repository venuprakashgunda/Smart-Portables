...
public class SalesmanHome extends HttpServlet {
    ...
    protected void displaySalesmanHome(HttpServletRequest request,
        ...
        pw.print("<table style='width:100%'><tr>");
        pw.print("<td><h4>Username</h4></td><td><input type='text' name='username' value='' class='input' required></input></td>");
        pw.print("</tr>");
        pw.print("<tr><td><h4>Password</h4></td><td><input type='password' name='password' value='' class='input' required></input></td>");
        pw.print("</tr>");
        pw.print("<tr><td><h4>Re-Password</h4></td><td><input type='password' name='repassword' value='' class='input' required></input></td>");
        pw.print("</tr>");
        pw.print("<tr><td><input type='submit' class='btnbuy' value='Create Customer' name='customer' style='float: right;height: 20px margin: 20px; margin-right: 10px;'></input></td>");
        pw.print("</tr>");
        pw.print("<tr><td></td>");
        pw.print("<td></td></tr></table>");
