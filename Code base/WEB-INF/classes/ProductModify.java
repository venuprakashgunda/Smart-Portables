	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
                    ...
                    +"<option value='laptops' selected>Laptop</option>"
                    +"<option value='phones'>Phone</option>"
                    +"<option value='tvs'>TV</option>"
                    +"<option value='soundsystems'>SoundSystem</option>"
                    +"<option value='headphones'>HeadPhone</option>"
                    +"<option value='fitnesswatches'>FitnessWatch</option>"
                    +"<option value='soundsystems'>SoundSystem</option>"
                    +"<option value='smartwatches'>SmartWatches</option>"
                    +"<option value='voiceassistants'>VoiceAssistant</option>"
                    ...
                    + "<h3>Product Image</h3></td><td><img id=\"preview\" /><br/><input type='file' name='productImage' value='' class='input' required></input>"
                    + "</td></tr><tr><td>"
		...
		}else if (action.equals("Updateproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
                    ...
                    + "<h3>Product Image</h3></td><td><img id=\"preview\" /><br/><input type='file' name='productImage' value='' class='input' required></input>"
                    // + "<h3>Product Image</h3></td><td><input type='text' name='productImage' value='' class='input' required></input>"
                    // +"<td><img id=\"preview\" /><br/><input type='file' name='productImage' value='' class='input' required>
					+ "</td></tr><tr><td>"
					+ "<h3>Product Manufacturer</h3></td><td><input type='text' name='productManufacturer' value='' class='input' required></input>"
					+ "</td></tr><tr><td>"
					+ "<h3>Product Condition</h3></td><td><input type='text' name='productCondition' value='' class='input' required></input>"
